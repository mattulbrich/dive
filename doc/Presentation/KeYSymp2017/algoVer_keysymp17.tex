...
\begin{frame}[c]{Motivation}
 ...
 \end{itemize}
\vspace{2ex}
Switching \emph{views} is costly and not well supported
\end{frame}
...
\begin{frame}[t]{State-of-the-Art Verification Systems: Autoactive}
BILD mit Uberlappung von Beweisfuehrung und Programm/Spec; viel Distanz zu Beweisverplifchtung
\end{frame}

\begin{frame}[t]{State-of-the-Art Verification Systems: script}
BILD mit naher von Beweisfuehrung und  Beweisverplifchtung; Distanz zu programm/Spec
\end{frame}

\begin{frame}[t]{State-of-the-Art Verification Systems: Autoactive}
BILD mit Naehe Beweisfuehrung Beweisverplifchtung (diese sehr gross) ein bisschen Distanz und Programm/Spec
\end{frame}
