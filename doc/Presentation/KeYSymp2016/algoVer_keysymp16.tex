...
\title{Towards a Proof View at the Phase Trasnition between Autoactive and 
...
correction of mistake/providing right information 
 \end{itemize}
For each iteration it is necessary to inspect different projections of the 
problem into different domains.
\begin{itemize}
 ...
 \item ...
\end{itemize}
Switching between projections (if they exist) is costly and not well supported 
in the process.
...
Three interaction principles for guiding the proof search have 
emerged: 
\begin{itemize}
\item autoactive
...
\end{itemize}
\vskip5em
\includegraphics[width=\textwidth]{../images/categorization.png}
...
\end{frame}
\begin{frame}[t]{Interactive: Point-and-Click}
\includegraphics[width=\textwidth]{../images/interactive.png}
\end{frame}

\begin{frame}[t]{Autoactive}
\includegraphics[width=\textwidth]{../images/autoactive.png}
\end{frame}

\begin{frame}[t]{Text-Based Interaction}
\includegraphics[width=\textwidth]{../images/tui.png}
\end{frame}
...
\begin{block}{Pros and Cons}
 \begin{itemize}
  \item +/- all necessary information available
  \item + full proof control
  \item - interaction can be tedious
  \item - error recovery 
  \item - two mental models have to be kept in sync
 \end{itemize}
...
\begin{block}{Pros and Cons}
 \begin{itemize}
  \item + interaction on input representation 
$\rightarrow$ only one mental model
 \item + comprehensible annotations
 \item - missing detailed insight into logical level when proof attempt fails 
...
\begin{frame}[t]{Text/Script-Based interaction}
\begin{block}{Level of Interaction (proof guidance)} 
 Problem input on program level, proof guidance on logical level (two mental 
models)
\end{block}
...
\begin{block}{Pros and Cons}
 \begin{itemize}
  \item + problem/proof decomposition in smaller parts
  \item + interaction steps more coarse grained than point-and-click 
$\rightarrow$ more readable/comprehensible and proof plan expressible
  \item +/- limited insight into logical level
  \item - two mental models may have to be kept in sync
...
Interaction concept supporting interactive, 
semi-automated proof guidance for an effective and efficient proof process. 
% 
...
\end{block}
\begin{block}{Decrease cost per iteration}

 \begin{itemize}
  \item If necessary allow for state inspection on logical level
  \item Making dependencies visible between levels
...
\begin{frame}[t]{Architecture}
 \begin{figure}
  \includegraphics[width=.9\textwidth]{../images/aufbau.png}
 \end{figure}
...
\begin{frame}[t]{Discussion}
 ...
 \begin{itemize}
  \item finding cause of failed proof?
  \item convince KeY, that proof can be found?
 \end{itemize}
