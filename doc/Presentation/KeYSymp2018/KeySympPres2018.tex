...
\only<1> { \includegraphics[width=\textwidth]{ipv1.png}}
\only<2> { \includegraphics[width=\textwidth]{ipv2.png}}
\only<3> { \includegraphics[width=\textwidth]{ipv3.png}}
\only<4> { \includegraphics[width=\textwidth]{ipv4.png}}
...
\begin{itemize}
 ...
 \item Symbolic execution (à la \KeY{})
