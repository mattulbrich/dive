...
public class DiveCenter {
     ...
     * Type: Boolean
     */
    public static final Property<Boolean> onGoingProof =
            new Property<>("onGoingProof", Boolean.class, true);

    /**
     * There are 3 viewports and they can be switched
     */
    public static final Property<Viewport> viewPort =
            new Property<>("viewPort", Viewport.class, null);

    public static final Property<Project> project =
     ...
     *             initialized.
     */
    public DiveCenter(URL url) throws IOException {
        this.projectURL = url;
        this.prettyPrinter = new PrettyPrint();

        mainController = new MainController(this, url.getFile());
