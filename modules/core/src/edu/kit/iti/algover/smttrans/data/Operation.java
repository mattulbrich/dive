...
public enum Operation {
  ...
  OR, SETEMPTY, PLUS, MINUS, TIMES, IMP, GT, LT, EQ, NOT, GE, LE, NEG, ITE, ARR2SELECT, ARRSTORE, ARR2STORE, FIELDSTORE, FIELDSELECT, DECR, SETUNION, SETINTERSECT, SETCARD, SEQCONCAT, ISCREATED, CREATE, ANON, SEQCONS, SEQEMPTY, SEQUPD, SEQGET, SEQLEN, SETIN, SETADD, CONST, ARRLEN, ARR2LEN0, ARR2LEN1, EXISTS, FORALL, LET, ARRSELECT, VAR, HEAP, AND, BV, MOD, AHEAP, EVERYTHING;
    ...
    static {
        ...
        SETUNION.smt = "union";
        SETUNION.poly = true;
        SETUNION.instantiations = asList(Axiom.SETEMPTY_INST,Axiom.SET_IN,Axiom.SET_INSERT,Axiom.SET_1,Axiom.SET_2,Axiom.SET_UNION,Axiom.SET_2);

        SETADD.smt = "setInsert";
        SETADD.poly = true;
        SETADD.instantiations = asList(Axiom.SETEMPTY_INST,Axiom.SET_IN,Axiom.SET_INSERT,Axiom.SET_1,Axiom.SET_2,Axiom.SET_INSERT,Axiom.SET_CARD);
        SETINTERSECT.smt = "intersect";
        SETINTERSECT.poly = true;
        SETINTERSECT.instantiations = asList(Axiom.SETEMPTY_INST,Axiom.SET_IN,Axiom.SET_INSERT,Axiom.SET_1,Axiom.SET_2,Axiom.SET_INTERSECT,Axiom.SET_3);

        SETCARD.smt = "setcard";
        SETCARD.poly = true;
        SETCARD.instantiations = asList(Axiom.SETEMPTY_INST,Axiom.SET_IN,Axiom.SET_INSERT,Axiom.SET_1,Axiom.SET_2,Axiom.SET_CARD,Axiom.SET_CARD,Axiom.SET_CARD_1,Axiom.SET_CARD_2); //,Axiom.SET_CARD_3,Axiom.SET_CARD_4
        ...
        SETIN.smt = "inSet";
        SETIN.poly = true;
        SETIN.instantiations = asList(Axiom.SETEMPTY_INST,Axiom.SET_IN,Axiom.SET_INSERT,Axiom.SET_1,Axiom.SET_2,Axiom.SET_IN);
