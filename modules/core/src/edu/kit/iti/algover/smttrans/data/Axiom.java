...
public enum Axiom {
    ...
    static {
        ...
        MULTISETEMTPY_INST.smt = "(declare-const (par (T) (msetEmpty<T> (MultiSet<T>))))";
        ...
        MULTISET_CARD.smt = "(declare-fun (par (T) (mcard<T> ((MultiSet<T>)) Int)))";
        ...
        MODH.smt = "(declare-const modh Set<Object>)";
        EVERYTHING.smt = "(declare-const everything Set<Object>)";
        ...
        SET_7.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 Set<T>)\r\n" + "    (s2 Set<T>)\r\n"
                ...
                + "        :pattern ((subset<T> s1 s2) (inSet<T> t s1))\r\n" + "    ) \r\n" + ")))";
        ...
        MULTISET_1.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 (MultiSet<T>))\r\n" + "    (t T)\r\n"
                + ")\r\n" + "    (! \r\n" + "        (>= (msetselect<T> s1 t) 0)\r\n"
                + "         :pattern((msetselect<T> s1 t))\r\n" + "    ) \r\n" + ")))";
        MULTISET_2.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (t T)\r\n" + ")\r\n" + "    (! \r\n"
                + "        (= (msetselect<T> msetEmpty<T> t) 0)\r\n" + "         :pattern((msetselect<T> msetEmpty<T> t))\r\n"
                + "    ) \r\n" + ")))";
        MULTISET_3.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 (MultiSet<T>))\r\n"
                + "    (s2 (MultiSet<T>))\r\n" + "    (t T)\r\n" + ")\r\n" + "    (! \r\n"
                + "        (= (msetselect<T> (mintersect<T> s1 s2) t)\r\n"
                + "        (min (msetselect<T> s1 t) (msetselect<T> s2 t))\r\n"
                + "        ) :pattern((msetselect<T> s1 t) (msetselect<T> s2 t))\r\n" + "    ) \r\n" + ")))";
        MULTISET_4.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 (MultiSet<T>))\r\n"
                + "    (s2 (MultiSet<T>))\r\n" + "    (t T)\r\n" + ")\r\n" + "    (! \r\n"
                + "        (= (msetselect<T> (munion<T> s1 s2) t)\r\n"
                + "        (+ (msetselect<T> s1 t) (msetselect<T> s2 t))) \r\n"
                + "        :pattern((msetselect<T> s1 t) (msetselect<T> s2 t))\r\n" + "    ) \r\n" + ")))";
        MULTISET_5.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 (MultiSet<T>))\r\n"
                + "    (s2 (MultiSet<T>))\r\n" + "    (t T)\r\n" + ")\r\n" + "    (! \r\n"
                + "        (= (msetselect<T> (msetminus<T> s1 s2) t)\r\n"
                + "            (max (- (msetselect<T> s1 t)  (msetselect<T> s2 t))  0)\r\n" + "        )\r\n"
                + "        :pattern ((msetselect<T> s1 t) (msetselect<T> s2 t))\r\n" + "    ) \r\n" + ")))";
        ...
        MULTISET_7.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s (MultiSet<T>))\r\n" + "    (t T)\r\n"
                + ")\r\n" + "    (!\r\n"
                + "        (= (msetselect<T> (msetinsert<T> t s) t) (+ (msetselect<T> s t) 1)) :pattern((msetinsert<T> t s))\r\n"
                + "    )\r\n" + "     \r\n" + ")))";
        MULTISET_8.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s (MultiSet<T>))\r\n" + ")\r\n"
                + "    (! \r\n" + "        (=> (= (mcard<T> s) 0)\r\n" + "        (= s msetEmpty<T>)) \r\n"
                + "        :pattern ((mcard<T> s))\r\n" + "    ) \r\n" + ")))";
        MULTISET_CARD_1.smt = "(assert (par (T) (= (mcard<T> msetEmpty<T>) 0)))";
        MULTISET_CARD_2.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s (MultiSet<T>))\r\n" + ")\r\n"
                + "    (! \r\n" + "        (>=  (mcard<T> s) 0) \r\n" + "        :pattern ((mcard<T> s))\r\n" + "    ) \r\n"
                + ")))";
        MULTISET_CARD_3.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s1 (MultiSet<T>))\r\n"
                + "    (s2 (MultiSet<T>))\r\n" + ")\r\n" + "    (! \r\n" + "        (=> (msubset<T> s1 s2)\r\n"
                + "        (<= (mcard<T> s1) (mcard<T> s2))) \r\n" + "        :pattern ((msubset<T> s1 s2))\r\n"
                + "    ) \r\n" + ")))";
        MULTISET_CARD_4.smt = "(assert (par (T)\r\n" + "(forall\r\n" + "(\r\n" + "    (s (MultiSet<T>))\r\n"
                + "    (t T)\r\n" + ")\r\n" + "    (! \r\n"
                + "        (= (mcard<T> (msetinsert<T> t s))  (+ (mcard<T> s) 1))\r\n"
                + "        :pattern ((msetinsert<T> t s))\r\n" + "    ) \r\n" + ")))";
