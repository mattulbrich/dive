...
public class TermLiteral extends Literal {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TermLiteral)) return false;
        final TermLiteral other = (TermLiteral) o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof TermLiteral;
    }

    public String toString() {
        return "edu.kit.iti.algover.script.ast.TermLiteral(text=" + this.getText() + ")";
    }
}
