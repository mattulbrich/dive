...
public class TermReferencesBuilderTest {
    ...
    public TermReferencesBuilderTest() throws TermBuildException, DafnyParserException, RuleException, FormatException {
        ...
        before = mockProofNode(null, xEqY);
        after = mockProofNode(before, yEqX, xEqY);
    ...
    public void referencesBuiltAreValid() {
        ...
        for (Reference reference : graph.getGraph().nodes()) {
    ...
    private class ValidityTester implements ReferenceVisitor<Boolean> {
        @Override
        public Boolean visit(CodeReference codeTarget) {
            return false; // This should not be generated by our test!
        }

        @Override
        public Boolean visit(ProofTermReference termTarget) {
            try {
        ...
        @Override
        public Boolean visit(UserInputReference userInputTarget) {
            return true;
        }
    }
    ...
    public void prettyPrintReferences() {
        ...
        int i = 0;
        for (EndpointPair<Reference> referenceEdge : graph.getGraph().edges()) {
