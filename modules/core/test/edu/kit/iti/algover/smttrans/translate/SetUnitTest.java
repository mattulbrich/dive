...
public class SetUnitTest {
    ...
    private static final String cdir = "modules/core/test-res/edu/kit/iti/algover/smttrans/translate/set/completeness".replace('/',
            File.separatorChar);
    private static final String sdir = "modules/core/test-res/edu/kit/iti/algover/smttrans/translate/set/soundness".replace('/',
            File.separatorChar);
