...
public class Arr2UnitTest {
    ...
    private static final String cdir = "modules/core/test-res/edu/kit/iti/algover/smttrans/translate/arr2/completeness".replace('/',
            File.separatorChar);
    private static final String sdir = "modules/core/test-res/edu/kit/iti/algover/smttrans/translate/arr2/soundness".replace('/',
            File.separatorChar);
