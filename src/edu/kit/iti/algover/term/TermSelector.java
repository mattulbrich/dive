...
public final class SubtermSelector implements Comparable<SubtermSelector> {
     ...
     *            the path to augment
     */
    public SubtermSelector(SubtermSelector termSelector, int... path) {
     ...
     *            the second selector
     */
    public SubtermSelector(SubtermSelector sel1,
                           SubtermSelector sel2) {
     ...
     */
    public SubtermSelector(String descr) throws FormatException {
...
//    }
     ...
     */
    public Term selectSubterm(Term term) throws ProofException {
